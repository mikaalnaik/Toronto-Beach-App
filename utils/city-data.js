...
export function getAllBeachesForRange(start, endDate) {
  // if (!start || !end) {
...
export function getSpecificBeachForRange(beachID, startDate, endDate) {
...
export function getSpecificBeachAllTime(beachID) {
  // if (!startDate || !endDate || !beachID) {
  //   throw 'Both a start date and end date are required. We also expect a date format of YYYY-MM-DD';
  // }
  // return getFromApi(
